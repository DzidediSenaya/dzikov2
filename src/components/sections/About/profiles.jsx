import Image1 from '../../../assets/images/Gigi (3).jpg';
import Image2 from '../../../assets/images/Nick.webp';
import Image3 from '../../../assets/images/Ronak.jpg';
import Image4 from '../../../assets/images/Amit.jpg';
import Image5 from '../../../assets/images/Lola.webp';
import Image6 from '../../../assets/images/Godwin.webp';
import Image7 from '../../../assets/images/Naa.webp';
import Image8 from '../../../assets/images/Henry.webp';
import Image9 from '../../../assets/images/Freda.webp';
import Image10 from '../../../assets/images/Andy.webp';
import Image11 from '../../../assets/images/Fata.webp';
import Image12 from '../../../assets/images/Sam.webp';
...
const profiles = [
    {
        ...
        content: ` With a fervent dedication to climate justice, environmental sustainability, ethical sourcing, and web development, Dzidedi Senaya emerges as a formidable force in the realm of social entrepreneurship. As the co-founder of the Dziko Centre for Climate Justice, she champions causes close to her heart, advocating for tangible change and amplifying voices for a greener, more equitable world.
                                        ...
                                        In the realm of technology, Dzidedi is an adept web developer and software engineer with training from MEST Africa and ALX Africa. Armed with certifications in design thinking and high-performance teams, she has honed her craft through practical experiences, including a job simulation with Moreton Bay Regional Council. Dzidedi harbors a profound interest in leveraging her web development skills for the betterment of community development sectors, recognizing the transformative potential of technology in driving positive change.
    ...
    },
    {
        ...
        image: Image3,
        content: `Ronak Patel is a transformative leader and registered pharmacist whose career spans health, renewable energy, and environmental sustainability. After earning his pharmacy degree in 2009 in India, Patel dedicated five years to healthcare practice, gaining profound insights into community well-being. Motivated by a desire to address global challenges, he transitioned to sustainable development, leveraging innovation to drive impactful change.

In 2016, Patel founded Ghana's first biomass utilization project under JSK Renewable Energy Ltd, pioneering the production of biomass pellets. This trailblazing initiative tackled environmental issues head-on while uplifting rural communities. Through educational programs, he championed smokeless, hygienic cooking solutions using cost-effective, carbon-neutral biomass pellets—setting new standards for eco-friendly living.

In 2023, Patel deepened his commitment to sustainability during a pivotal visit to Germany, where he explored cutting-edge biogas production technologies. Inspired by this experience, he launched an organic farming initiative that utilizes biogas byproducts to produce organic fertilizers. This innovation not only enhances soil health but also mitigates climate change, reflecting Patel’s forward-thinking approach to global warming solutions.

As the CEO of JP Agro and Rental Services Ltd., Patel continues to redefine leadership in the renewable energy and agricultural sectors. His work integrates environmental stewardship with economic empowerment, embodying a vision of a greener, more sustainable future for communities worldwide.`
    },
    {
        id: 4,
        name: 'Amit Patel',
        role: 'Executive Director',
        image: Image4,
        content: `Amit Patel is an accomplished businessman and director of pioneering enterprises, including JSK Renewable Energy Ltd and JP Agro and Rental Services Ltd. Renowned for his innovative leadership, Patel has carved a niche in advancing environmentally conscious and agriculturally transformative initiatives.

With a deep-seated passion for sustainability, Patel has been at the forefront of projects that tackle pressing global challenges. His efforts in renewable energy, particularly through JSK Renewable Energy Ltd, have promoted cleaner, greener alternatives, while his contributions to agricultural innovation have empowered communities and supported sustainable farming practices.

Driven by a profound wish for a greener future, Patel continues to merge business acumen with environmental stewardship, leaving an indelible mark on both industries. His exceptional vision and unwavering dedication serve as a testament to the impact one leader can have in building a more sustainable and prosperous world.
`
    },
    {
        id: 5,
